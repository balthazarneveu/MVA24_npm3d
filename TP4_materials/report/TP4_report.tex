...
computation time. We highlight this impact on figure \ref{fig:SPR_octree}.
...
are reported in table \ref{tab:HoppeTable}. Our implementation takes 22 seconds to run
