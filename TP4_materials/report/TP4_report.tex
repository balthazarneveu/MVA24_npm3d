...
% @QUESTION! We should probably mention that we used pytorch 
% GPU implentations gets hihgly efficient parallelization nearlyfor free. 
...
% @QUESTION!
% Where do the lonely surfaces come from? (the ones that are not connected to the main mesh)
% How do kernels affect the SDF when we're far away from the surface? ... this should be fairly easy but there may
% be some interesting things to say about it and an issue with scale!
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.3\linewidth]{figures/SPR.png}
  \includegraphics[width=0.3\linewidth]{figures/Hoppe.png}
